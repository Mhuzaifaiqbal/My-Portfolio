...
//           className="text-6xl md:text-8xl lg:text-9xl font-bold mb-6 text-electric leading-tight"
...
//           className="mb-8"
//         >
//           <h2 className="text-2xl md:text-4xl lg:text-5xl font-semibold text-cyber mb-4">
//             Aspiring AI/ML Engineer
//           </h2>
//           <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
//           Integrating AI and ML models into real-world experiences with precision and creativity          </p>
//         </motion.div>
...
//       >
//         {/* <FaChevronDown className="text-2xl text-primary animate-pulse" /> */}
//       </motion.div>

//       {/* Floating elements */}
//       <motion.div
//         // className="absolute top-20 left-20 w-4 h-4 bg-accent rounded-full animate-float"
//         // animate={{ rotate: 360 }}
//         // transition={{ duration: 20, repeat: Infinity, ease: "linear" }}
//       />
//       <motion.div
//         // className="absolute bottom-20 right-20 w-6 h-6 bg-secondary rounded-full animate-float"
//         // style={{ animationDelay: '2s' }}
//         // animate={{ rotate: -360 }}
//         // transition={{ duration: 25, repeat: Infinity, ease: "linear" }}
//       />
//       <motion.div
//         // className="absolute top-1/2 right-10 w-3 h-3 bg-primary rounded-full animate-float"
